...
public class SootFX {
  ...
  private void validate() {
    if (classPaths == null || classPaths.isEmpty()) {
      throw new RuntimeException(
          "Class Path not set. call addClassPath(/class/path/to/target/program)");
    }
  }

  public Set<MethodFeatureSet> extractMethodFeaturesInclude(Set<MethodFEU> featureExtractors) {
    validate();
    View view = SootConnector.sootupConnector(classPaths, androidJars);
  ...
  public Set<MethodFeatureSet> extractMethodFeaturesExclude(
  ...
  public Set<MethodFeatureSet> extractMethodFeaturesInclude(
  ...
  public Set<ClassFeatureSet> extractClassFeaturesExclude(
      Set<String> exclusion, List<FeatureResource> featureResources) {
    validate();
    View view = SootConnector.sootupConnector(classPaths, androidJars);
  ...
  public Set<ClassFeatureSet> extractClassFeaturesInclude(
      List<String> featureExtractors, List<FeatureResource> featureResources) {
    validate();
    View view = SootConnector.sootupConnector(classPaths, androidJars);
  ...
  public WholeProgramFeatureSet extractWholeProgramFeaturesInclude(
      Set<WholeProgramFEU> featureExtractors) {
    validate();
    View view = SootConnector.sootupConnector(classPaths, androidJars);
  ...
  public WholeProgramFeatureSet extractWholeProgramFeaturesExclude(
      Set<String> exclusion, List<FeatureResource> featureResources) {
    validate();
    View view = SootConnector.sootupConnector(classPaths, androidJars);
  ...
  public void printMultiSetToCSV(Set<? extends AbstractFeatureSet> set, String path)
      throws IOException {
    boolean isFirst = true;
