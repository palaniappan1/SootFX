...
public class SootConnector {
    ...
    public static View sootupConnector(String mainClass, List<String> classPaths, boolean appOnly, String androidJars) {
        ...
        if (isAPK) {
            ...
            classPaths.forEach(c -> {
                apkAnalysisInputLocations.add(new ApkAnalysisInputLocation(Paths.get(c), androidJars, DexBodyInterceptors.Default.bodyInterceptors()));
            });
