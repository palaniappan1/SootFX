...
public class MethodFX implements MultiInstanceFX<MethodFeatureSet, MethodFEU> {
  ...
  private static final Set<String> NEED_VIEW =
      new HashSet<>(
          Set.of(
              "IsMethodClassAbstract",
              "IsMethodClassFinal", "IsMethodClassStatic",
              "IsMethodClassInnerClass",
              "IsMethodThreadRun",
              "MethodClassAccessModifier",
              "MethodParamIsInterface",
              "MethodCallsMethod"));
  ...
  @Override
  public Set<MethodFeatureSet> getAllFeaturesExclude(
  ...
  @Override
  public Set<MethodFeatureSet> getFeatures(
    ...
    for (String str : featureExtractors) {
      ...
      try {
        ...
        if (List.of("MethodReturnTypeEquals", "MethodCallsMethod").contains(str)
            && featureResource.isPresent()) {
  ...
  private static MethodFeatureSet extractMethodFeature(
      SootMethod sootMethod, Set<MethodFEU> featureExtractors) {
